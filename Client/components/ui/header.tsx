...
export default function Header() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      setTimeout(() => setShowSignupDialog(false), 2000);
    } else {
...
// Google signup placeholder (add this function)
const handleGoogleSignup = () => {
  setMessage('🔄 Google OAuth coming soon in next PR!');
};
...
<Dialog open={showSignupDialog} onOpenChange={setShowSignupDialog}>
  ...
  <div className="space-y-4">
    {/* Google Signup Button (UI Only for now) */}
    <Button
