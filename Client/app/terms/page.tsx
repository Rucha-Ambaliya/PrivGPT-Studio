          ...
          <div className="container mx-auto max-w-4xl">
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <Card className="mb-8">
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    Users must use PrivGPT-Studio responsibly and comply with
                    all applicable laws.
                  </p>
              ...
              <Card className="mb-8">
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    Users are strictly prohibited from engaging in activities
                    that violate the law or infringe on others' rights.
                  </p>
                  <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              ...
              <Card className="mb-8">
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    PrivGPT-Studio is provided "as is" without warranties. We
