            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                      ...
                      <li>
                        <strong>Support Communications:</strong> Messages you
              ...
              <Card className="mb-8">
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                      <li>
                        Process and respond to your chat messages via
                        cloud-based AI models
                      </li>
                      <li>
                        Maintain your conversation history (for cloud models
                        only)
                      </li>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground mb-2">
                      When you use cloud-based models (like Gemini), your
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                      ...
                      <li>
                        <strong>Usage Analytics:</strong> Aggregated data
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <p className="text-sm">
                            Required for basic functionality (login,
                            preferences)
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <p className="text-sm">
                            Help us understand usage patterns (optional,
                            requires consent)
                          </p>
                        </div>
                      </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      our cookie preferences center. Note that disabling
              ...
              <Card className="mb-8">
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    ...
                    residence, including the United States. We ensure
              ...
              <Card className="mb-8">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    ...
                    the EU). We do not knowingly collect personal information
              ...
              <Card className="mb-8">
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    We will respond to your privacy requests within 30 days (or
